...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md:flex flex-col text-sidebar-foreground bg-sidebar h-svh"
        data-state={state}
